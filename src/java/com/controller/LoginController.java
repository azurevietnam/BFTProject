        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (action != null) {
                if (action.equals("Login")) {
                    ...
                    User u = uc.searchUser(usrName);
                    if (u.getPassword().equals(oldPassword)) {
                        uc.changePassword(usrName, newPassword);
                        session.setAttribute("chgOK", "Change password sucessful!");
                        pageRedirect = "changePassword.jsp?username=" + usrName;
                    } else {
                        session.setAttribute("chgValid", "Old password is invalid!");
                        pageRedirect = "changePassword.jsp?username=" + usrName;
                    }
                }
            } else {
