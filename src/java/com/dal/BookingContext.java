...
public class BookingContext extends DBContext {
    ...
    /**
     * search BookingHistory by bookingID
     *
     * @param bookingID
     * @return
     * @throws Exception
     */
    public BookingHistory getBookingByID(String bookingID) throws Exception {
        BookingHistory bh = null;
    ...
    public int updateBookingStatus() throws Exception {
        String sql = "update BOOKING set booking_closed = 1\n"
                + "where detail_id in ( \n"
