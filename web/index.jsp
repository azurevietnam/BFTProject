   ...
   <body id="page">
      ...
      <%
         ...
         if (session.getAttribute("info") != null) {
            ...
            from = info.getFromLocation();
            to = info.getToLocation();
            date = info.getDepartureDate().toString();
         }
      %>
            ...
            <div class="col-md-10 col-md-offset-1 opacity-img-bg">
               ...
               <form action="FlightController" id="search_flight" class="form-horizontal">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-4">
                        <input type="text" class="form-control" name="fromLocation" id="from_location" value="<%=from%>"/>
                     </div>
                     <label class="col-md-2 control-label">To</label>
                     <div class="col-md-4">
                        <input type="text" class="form-control" name="toLocation" id="to_location" value="<%=to%>"/>
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-4">
                        <input type="date" class="form-control" name="departureDate" value="<%=date%>"/>
                     </div>
